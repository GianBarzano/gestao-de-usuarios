...
@Component({
  selector: 'app-meus-pets-edit',
  templateUrl: './meus-pets-edit.component.html',
  styleUrls: ['./meus-pets-edit.component.scss']
})
export class MeusPetsEditComponent implements OnInit {
  listaPets: any = {
    lista: [],
    page: 1,
    pages: 1
